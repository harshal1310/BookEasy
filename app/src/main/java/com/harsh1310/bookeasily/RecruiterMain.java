...
typeofuer=pref.gettypeofuser();
    ...
    public void dothis(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.electrician:
             ...
             if(typeofuer.equals("User"))
             {intent = new Intent(RecruiterMain.this , SearchActivity.class);
                startActivity(intent);}
             else{
                 pref.setprofession("Electrician");
                 intent = new Intent(RecruiterMain.this , showworkers.class);
                 startActivity(intent);
             }
                break;
    ...
    {
        if(pref.gettypeofuser().equals("Agency")){
            Intent intent=new Intent(RecruiterMain.this,Agency.class);
            startActivity(intent);
        }
else
    super.onBackPressed();
